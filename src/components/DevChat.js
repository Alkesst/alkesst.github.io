...
export default () =>
    <div>
        ...
        <p className="text-justify">
            DevChat is a console network chat created using C and SSL. The chat is composed by a server and a client.
            The server receives all the messages from the users, and sends them to all the other users.
            The client is a console app that prints all the messages received and send cyphered messages from the users.
        ...
        <p className="text-justify">
            Simply, I was bored studying the subjects of my degree, so I decided, along with my brother, making this Chat.
