...
const Card = ({projectName, title, text, link, tryProject, children }) =>
    <div className="mb-3">
        <div className="card">
...
export default () =>
    <div>
        <Card projectName="PytelBot" link="http://github.com/alkesst/pytelbot" title="Playful bot in telegram"
            tryProject="https://telegram.me/pytel_bot">
        ...
        <Card projectName="Dev-Chat" link="http://github.com/alkesst/dev-chat"
              title="A chat made by developers, for developers.">
        ...
        tryProject="http://twitter.com/pytwe_bot">
        ...
        <Card projectName="ConsejoInfUma page" link="https://github.com/ConsejoInfUMA"
              title="Web page for the Council of students of the higher technical school of computer science">
